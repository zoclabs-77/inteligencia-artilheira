...
## Placares confirmados — 30/06

- **França 3 x 0 Suécia** — Show de Mbappé: dois gols do camisa 10 e um de Barcola selaram a classificação tranquila dos franceses para as oitavas. Mbappé bateu recorde histórico de artilheiro em mata-matas de Copa, ultrapassando Leônidas da Silva e Ronaldo Fenômeno (10 gols em eliminatórias).
- **Costa do Marfim 1 x 2 Noruega** — Antonio Nusa abriu para a Noruega aos 39', Amad Diallo empatou aos 74'. Haaland sacramentou aos 86' e classificou os noruegueses para enfrentar o Brasil nas oitavas, em Nova York.
- **México 2 x 0 Equador** — Os mexicanos venceram em casa (Azteca) com dois gols e quebraram o histórico de eliminação na primeira rodada do mata-mata. Equador é eliminado após surpreendente campanha na fase de grupos.

## Placares confirmados — 01/07

- **Inglaterra 2 x 1 RD Congo** — Brian Cipenga abriu o placar para a RD Congo aos 6' do 1º tempo, mas Harry Kane virou sozinho com dois gols na etapa final (em Atlanta) e classificou a Inglaterra, que enfrenta o México nas oitavas (05/07, Estádio Azteca).
...
## Palpites × Resultado — 30/06 (jogos 77-79)

| # | Jogo | Claude | Codex | Baseline | Real | Cla | Cdx | Base |
|---|---|---|---|---|---|---|---|---|
| 77 | França x Suécia | 2-0 | 3-1 | 1-0 | **3-0** | 1 | 1 | 1 |
| 78 | Costa do Marfim x Noruega | 1-2 | 1-2 | 0-1 | **1-2** | 3⭐ | 3⭐ | 2 |
| 79 | México x Equador | 1-0 | 1-0 | 1-0 | **2-0** | 1 | 1 | 1 |
| | **Total do lote** | | | | | **5** | **5** | **4** |

⭐ = placar exato (3 pts). Claude e Codex cravaram o placar exato da Noruega (1-2), o destaque do dia. Todos acertaram os vencedores nos três jogos, mas saldo errado em França (3-0 real vs 2-0/3-1/1-0 previstos) e México (2-0 real vs 1-0 previsto). Baseline ficou 1 pt atrás por acertar só o vencedor na partida da Noruega em vez do placar exato.

## Palpites × Resultado — 01/07 (jogos 80-82)

| # | Jogo | Claude | Codex | Baseline | Real | Cla | Cdx | Base |
|---|---|---|---|---|---|---|---|---|
| 80 | Inglaterra x RD Congo | 2-0 | 2-1 | 1-0 | **2-1** | 1 | 3⭐ | 2 |
| 81 | EUA x Bósnia | 2-1 | 2-1 | 1-0 | **2-0** | 1 | 1 | 1 |
| 82 | Bélgica x Senegal | 2-1 | 2-1 | 1-0 | **3-2** | 2 | 2 | 2 |
| | **Total do lote** | | | | | **4** | **6** | **5** |
...
| # | Jogo | Claude | Codex | Baseline | Real | Cla | Cdx | Base |
|---|---|---|---|---|---|---|---|---|
| 83 | Portugal x Croácia | 2-1 | 2-1 | 1-0 | **2-1** | 3⭐ | 3⭐ | 2 |
| 84 | Espanha x Áustria | 2-0 | 2-0 | 1-0 | **3-0** | 1 | 1 | 1 |
| 85 | Suíça x Argélia | 2-1 | 2-1 | 1-0 | **2-0** | 1 | 1 | 1 |
| | **Total do lote** | | | | | **5** | **5** | **4** |
...
- **DUPLA ZEBRA NOS PÊNALTIS (29/06):** Alemanha e Holanda, duas das favoritas ao título, caíram no mesmo dia — ambas empatando 1-1 e perdendo nos pênaltis (Paraguai 4-3 sobre a Alemanha, Marrocos 3-2 sobre a Holanda). Os três modelos previram vitória dos favoritos e zeraram em ambos.
- **BRASIL SOFRE MAS CLASSIFICA (29/06):** Japão saiu na frente com Kaishu Sano, mas Casemiro e Martinelli viraram para o Brasil. Claude e Codex cravaram o 2-1 exato.
- **MBAPPÉ HISTÓRICO (30/06):** França 3x0 Suécia com dois gols de Mbappé — 10 gols em mata-matas, recorde absoluto da Copa do Mundo.
- **NORUEGA ENFRENTA O BRASIL (30/06):** Noruega eliminou a Costa do Marfim com gol tardio de Haaland (86'). Claude e Codex cravaram o 1-2 exato — placares exatos nos 16 avos.
- **KANE DECIDE (01/07):** RD Congo assustou saindo na frente aos 6', mas Harry Kane virou sozinho para a Inglaterra na etapa final. Codex cravou o 2-1 exato.
- **EUA PASSA COM UM A MENOS (01/07):** Balogun marcou e foi expulso no mesmo lance de jogo contra a Bósnia, mas os EUA seguraram a vantagem e ainda ampliaram com Tillman.
